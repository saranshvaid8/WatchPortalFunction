...
namespace WatchPortalFunctionWatchFunction.Test
{
    public class WatchFunctionTests
    {
        ...
        public void TestWatchFunctionSuccess()
        {
            ...
            dynamic watchinfo = new { Manufacturer = "Rolex", CaseType = "Solid", Bezel = "Titanium", Dial = "Roman", CaseFinish = "Silver", Jewels = 15 };
